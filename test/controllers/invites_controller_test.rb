...
class InvitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invite" do
    assert_difference('Invite.count') do
      post invites_url, params: { invite: { game_id: @invite.game_id, user_from: @invite.user_from, user_to: @invite.user_to } }
    end
  ...
  test "should update invite" do
    patch invite_url(@invite), params: { invite: { game_id: @invite.game_id, user_from: @invite.user_from, user_to: @invite.user_to } }
